    ...
    <img src="{{ asset( basename($qr)) }}" alt="QR Code"
         ...
         onerror="this.onerror=null;this.src='https://via.placeholder.com/220?text=QR+no+disponible';">
                            ...
                            <div class="p-3 mt-4 rounded" style="background-color: #f8f9fa;">
                                ...
                                <div>
                                    <label class="form-label text-muted">Correo electrónico del servidor para acreditar
                                        pago:</label>
                    ...
                    <div class="payment-step d-none" id="step2">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="concept" id="concept" placeholder="Order ID"
                                required>
                        </div>
                    ...
                    <div class="payment-step d-none" id="step3">
                        ...
                        <form id="paymentForm" action="{{ route('zeta') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4 file-upload-area text-center p-5">
                                <input type="file" class="d-none" id="screenshot" name="screenshot" accept="image/*"
                                    required>
...
<script>
    ...
    nextButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (nextStepId <= 3) {
                ...
                // Paso 1 → Paso 2: guardar amount y email
                if (nextStepId === 2) {
    ...
    // Asegurar que concept se actualice justo antes de enviar
