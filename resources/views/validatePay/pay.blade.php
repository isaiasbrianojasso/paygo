            ...
            <div class="border-0 shadow-sm card">
                ...
                <div class="p-4 card-body">
                    ...
                    <div class="payment-step" id="step1">
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold" style="color: #003087;">Correo electrónico del
                                Server</label>
                        ...
                        <button class="py-2 btn w-100 fw-bold next-step"
                            style="background-color: #003087; color: white;">
                    ...
                    <div class="payment-step d-none" id="step2">
                        <div class="mb-4 text-center">
                            ...
                            <div class="p-3 mt-3 bg-white border rounded d-inline-block">
                                <img src="{{ route(name: 'qr') }}" alt="QR de pago Zeta"
